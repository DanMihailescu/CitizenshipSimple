...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: The Oath of Citizenship</title>
...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
	...
	<h1 class="pink-text" style="font-weight: bold;">The Oath of Citizenship</h1>
...
I swear (or affirm)<br>
That I will be faithful<br>
And bear true allegiance<br>
To Her Majesty Queen Elizabeth the Second<br>
Queen of Canada<br>
Her Heirs and Successors<br>
And that I will faithfully observe<br>
The laws of Canada<br>
And fulfil my duties as a Canadian citizen.<br>
	...
	e.preventDefault();
	  var name = $("input[name=name]").val();
        ...
        $.ajax({
           ...
           data:{"module": 1, "section":1, "completion":"yes", "_token": "{{ csrf_token() }}"},
