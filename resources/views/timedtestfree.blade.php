...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Timed Test</title>
...
<div class="col-4 text-center" style="padding-top: 30px;">
 <i class="fas fa-hourglass-half text-warning fa-2x"></i> <span id="timer" class="h3 text-warning"></span>

</div>
<div class="col-4">           
		  <a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-danger btn-flat text-light" style="margin-top: 37px;">Exit <i class="fas fa-external-link-alt"></i></a>
          </div>
		  </div>
...
<div class="row questiontimer">
<div class="col-lg-12">
<div class="circle-wrap text-center" style="text-align: center;width: 100%;margin:auto;">
<a lang="0" class="circle 1"></a>
<a lang="1" class="circle 2"></a>
<a lang="2" class="circle 3"></a>
<a lang="3" class="circle 4"></a>
<a lang="4" class="circle 5"></a>
<a lang="5" class="circle 6"></a>
<a lang="6" class="circle 7"></a>
<a lang="7" class="circle 8"></a>
<a lang="8" class="circle 9"></a>
<a lang="9" class="circle 10"></a>
<a lang="10" class="circle 11"></a>
<a lang="11" class="circle 12"></a>
<a lang="12" class="circle 13"></a>
<a lang="13" class="circle 14"></a>
<a lang="14" class="circle 15"></a>
<a lang="15" class="circle 16"></a>
<a lang="16" class="circle 17"></a>
<a lang="17" class="circle 18"></a>
<a lang="18" class="circle 19"></a>
<a lang="19" class="circle 20"></a>
</div>
</div>
...
<div class="row" style="padding-bottom: 25px;"><div class="col-lg-2"></div><div class="col-lg-8">	  
	...
	<h4 class="evaldes" style="color: #ff5555;"></h4>
	<a href="/citizenship-test" class="btn btn-lg btn-rounded">Return to Free Samples</a> 
		<a href="/upgrade" class="btn btn-lg btn-danger btn-rounded" style="background-color: #ff5555;color: #fff;">Free Registration</a> 
...
<div class="col-lg-2">
  ...
  <div class="resultrow"></div>
		<div class="text-center" style="margin:auto; margin-top: 50px; margin-bottom: 100px;">
		  	<a href="/citizenship-test" class="btn btn-lg btn-rounded">Return to Free Samples</a> 
<a href="/upgrade" class="btn btn-lg btn-danger btn-rounded" style="background-color: #ff5555;color: #fff;">Free Registration</a> 
</div>
  </div>
...
<div style="text-align: left;"> 
  ...
  <div style="text-align: right;"><button class="btn btn-danger btn-lg btn-rounded nextq" style="background-color: #ff5555; color: #fff;">Next Question</button><button class="btn btn-lg btn-rounded" id="prev">Previous Question</button>
</div>
  </div>
 </div>
 </div>
 ...
 <div class="col-3 p-3">
    <button class="btn btn-outline-white btn-lg btn-rounded">Next Question</button>
...
questions[q].difficulty = darray[q].difficulty;
  ...
  displayNext();
  	var prog = 0;
 var h = ($(window).height() - 108 - 200 - 50 - $('.content').height())*0.4;
...
function checkSecond(sec) {
  ...
  $('.nextq').on('click', function (e) {
	  $('.nextq').attr('disabled', true);
		...
		choose();
		questionCounter++;
		var qis = questionCounter + 1;
	var qistwo = '.' + qis.toString();
	$(qistwo).css('background-color', '#1e90FF');
		displayNext();
			  $('.nextq').attr('disabled', false);

  });
    // Switch Question by Circles
   ...
   $('.circle').on('click', function (e) {
	...
	questionCounter = parseInt($(this).attr("lang"));
	var qis = questionCounter + 1;
	var qistwo = '.' + qis.toString();
	$(qistwo).css('background-color', '#1e90FF');
    displayNext();
  ...
  function createQuestionElement(index) {
	...
	var header = '';
    var header = $('<label><strong>Question ' + (parseInt(index) + 1) + '</strong></label>');
  ...
  function createRadios(index) {
    ...
    for (var i = 0; i < questions[index].choices.length; i++) {
      ...
      input += '<span class="ans">' + questions[index].choices[i] + '</span></label></div>';
  ...
  function choose() {
	if($('input[name="answer"]:checked').size() > 0) {
		var qi = questionCounter + 1;
		var qitwo = '.' + qi.toString();
		$(qitwo).css('background-color', '#ff5555');
			$(qitwo).css('border-color', '#b53737');

	} else {
		
			var qi = questionCounter + 1;
		var qitwo = '.' + qi.toString();
		$(qitwo).css('background-color', '#eaeaea');
			$(qitwo).css('border-color', '#cccccc');
...
if(typeof questions[i].choices[selections[i]] == "undefined") {
	 questions[i].choices[selections[i]] = "Left Blank";
}
var inpone = '<div class="row d-flex text-left" style="border-bottom: 2px solid #f2f2f2;padding-top: 20px;"><div class="col-md-1">';
if(questions[i].choices[selections[i]] != "Left Blank" && selections[i] === questions[i].correctAnswer - 1) {
var inptwo = '<i class="fas fa-check-circle fa-2x text-default"></i>'	
} else {
var inptwo = '<i class="far fa-times-circle fa-2x text-danger"></i>'	
}	
var inpthree =   '</div> \
      <div class="col-md-5"> \
 ...
 <div class="col-md-3"> \
        ...
        <p class="text-muted mb-5 pb-2"> ' + questions[i].choices[questions[i].correctAnswer - 1] + '</p> \
      </div> \
	  </div>';

var inpfour = inpone + inptwo + inpthree;
	
	  $('.resultrow').append(inpfour);
