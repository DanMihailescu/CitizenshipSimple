...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Who We Are</title>
...
To understand what it means to be Canadian, it is important to know about our three founding peoples—Aboriginal, French and British.
 ...
 <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed your first section on Who We Are. Keeping going, or save your progress for later.</p>
    
       <a href="/discover-canada" class="btn btn-deep-purple btn-rounded">Save and Exit</button>
 <a href="/who/the-aboriginals" type="button" class="btn btn-danger btn-rounded">Continue Training</a>
...
$('#progressbar').animate({ width: "20%"}, 1000);
		...
		$.ajax({
           ...
           data:{"module": 3, "section":1, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"the-aboriginals"},
  ...
  function displayScore() {
    ...
    for (var i = 0; i < selections.length; i++) {
      ...
      if (selections[i] === questions[i].correctAnswer - 1) {
        numCorrect++;
