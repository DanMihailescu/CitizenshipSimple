...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
	...
	<h1 class="pink-text" style="font-weight: bold;">Who We Are</h1>
   <div class="d-flex justify-content-between progressbar">
            <small class="text-muted">Section Progress</small>
            <small><span><strong>1</strong></span>/<span></span>5</small>
          </div>
...
About 65% of the Aboriginal people are First Nations, while 30% are Métis and 4% Inuit.
 ...
 <a href="/who/english-and-french" class="btn btn-danger btn-rounded">Continue Training</a>
...
$('#progressbar').animate({ width: "60%"}, 1000);
        ...
        $.ajax({
           ...
           data:{"module": 3, "section":4, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"english-and-french"},
