...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Who We Are: Becoming Canadian</title>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
          ...
          <div class="progress lg-progress">
            <div id="progressbar" class="progress-bar bg-danger animated flash" style="width: 80%;" role="progressbar"></div>
          </div>
...
<div style="height: 100px;"></div>
 ...
 <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed the Who We Are of the Discover Canada guide. Keeping going, or save your progress for later.</p>
	...
	e.preventDefault();
	  var name = $("input[name=name]").val();
        ...
        $.ajax({
           ...
           data:{"module": 3, "section":4, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec": "who-we-are"},
