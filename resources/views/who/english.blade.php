...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
           ...
           <small>Now on <span><strong>3</strong></span>/<span></span>4</small>
          </div>
          <div class="progress lg-progress">
            <div id="progressbar" class="progress-bar bg-danger animated flash" style="width: 60%;" role="progressbar"></div>
          </div>
...
<div style="height: 100px;"></div>
 ...
 <a href="/who/becoming-canadian" class="btn btn-danger btn-rounded">Continue Training</a>
  </section>
  <!--Section: Content-->
...
$('#progressbar').animate({ width: "80%"}, 1000);
        ...
        $.ajax({
           ...
           data:{"module": 3, "section":3, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"becoming-canadian"},
