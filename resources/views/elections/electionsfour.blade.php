...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Federal Elections</title>
...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
	...
	<h1 class="pink-text" style="font-weight: bold;">Federal Elections</h1>
...
Provincial, territorial and municipal elections are held by secret ballot, but the rules are not the same as those for federal elections. It is important to find out the rules for voting in provincial, territorial and local elections so that you can exercise your right to vote.
 ...
 <thead> 
  <tr> 
   ...
   <th scope="col">Elected Officials </th> 
   <th scope="col">Some Responsibilities</th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
  ...
  <tr> 
   <td><strong>Provincial and Territorial</strong></td> 
   <td> 
    <ul> 
     <li>Members of the Legislative Assembly (MLAs) or</li> 
     <li>Members of the National Assembly (MNAs) or</li> 
     <li>Members of the Provincial Parliament (MPPs) or</li> 
     <li>Members of the House of Assembly (MHAs)</li> 
    </ul></td> 
   <td> 
    <ul> 
     <li>Education</li> 
  ...
  <tr> 
   <td><strong>Municipal (local)</strong></td> 
   <td> 
    <ul> 
     <li>Mayor or Reeve</li> 
     <li>Councillors or Aldermen</li> 
    </ul></td> 
   <td> 
    <ul> 
     <li>Social and Community Health</li> 
...
<div style="margin-bottom: 100px;">
  ...
  <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed the Federal Elections section of the Discover Canada guide. Keeping going!.</p>
...
$('#progressbar').animate({ width: "100%"}, 1000);	
        ...
        $.ajax({
           ...
           data:{"module": 7, "section":4, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"elections"},
