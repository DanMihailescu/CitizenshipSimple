...
<div style="text-align: left;"> 
 ...
 <div class="col-3 text-right p-3">
  ...
  <div class="row checksmall p-3">
  <div class="col-12">
  
  <div class="row">
 <div class="col-3 thumbsdown">
	<div class="ui-error">
		<svg  viewBox="0 0 87 87" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					<g id="Group-2" transform="translate(2.000000, 2.000000)">
 ...
 <div class="col-9 text-right">
  ...
  <!-- Copyright -->
 <!-- Copyright -->
<input type="hidden" id="test_type" name="test_type" value="<?php echo $_GET['type'];?>" />
...
if($points->mediumshort != null) { 
echo $points->mediumshort; } else { echo 0;} 
} elseif($_GET['test'] == 4) { if($points->mediumlong != null) { 
