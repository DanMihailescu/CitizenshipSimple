  ...
  <div class="modal-dialog modal-notify modal-success" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <p class="heading lead">Flashcard Break</p>
      ...
      <div class="modal-body">
        <div class="text-center">
			 ...
			 <div class="flashcard">
<div class="card card-image cardone" style="display:none;background-image: url(https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%2814%29.jpg);">
    <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
  <div>
      <h3 class="card-title pt-2 question" >  <i class="fas fa-chart-pie"></i> Self-Graded Flashcards
</h3>
</div>
    </div>
  </div>
...
<div class="btn-group" role="group" aria-label="Basic example">
  <button type="button" class="correct btn btn-outline-deep-purple btn-rounded waves-effect" style="display:none;"><i class="fas fa-anchor fa-sm pr-2"
      aria-hidden="true"></i> Correct</button>
   
  <button type="button" class="wrong btn btn-outline-deep-purple btn-rounded waves-effect" style="display:none;"><i class="fas fa-user-secret fa-sm pr-2"
      aria-hidden="true"></i> Wrong</button>
</div>

<div class="starter">
  <h3 class="font-weight-bold mb-4 pb-2">Start the Flashcard Quiz</h3>
    
    <p class="text-center mx-auto mb-4 pb-2">There will be twenty questions, self-scored. The test will continue rotating questions until every question is answered correctly.</p>
    
 <button type="button" class=" btn btn-danger btn-rounded waves-effect"><i class="fas fa-anchor fa-sm pr-2"
      aria-hidden="true"></i> Start Flashcard quiz!</button>
	  </div>
  <button type="button"  class="question_answer btn btn-outline-deep-purple btn-rounded waves-effect"><i class="fas fa-anchor fa-sm pr-2"
      aria-hidden="true"></i> Ready? Show Answer!</button>
      <div class="footer">
        <div class="stats">
...
<div class="container">
  <a class="navbar-brand" href="#">Discover Canada > <b>Canada's History</b></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-555">
	...
	<ul class="navbar-nav ml-auto" aria-label="breadcrumb">
	
	
  
	<li> <button type="button" class="btn peoples btn-warning shadow">Key</button></li>

 <li> <button type="button" class="btn peoples btn-danger shadow">Peoples</button></li>
  <li><button type="button" class="btn places btn-primary shadow">Places</button></li>
 <li> <button type="button" class="btn names btn-info shadow">Names</button></li>
   <li> <button type="button" class="btn dates btn-secondary shadow">Dates</button></li>
...
<!--/.Navbar -->
<div class="container px-5" style="padding-top: 40px;padding-bottom: 0!important;">
    ...
    <div class="row">
      ...
      <div class="col-12">
        ...
        <div class="view zoom z-depth-1 rounded mb-4">
          <a href="#!">
            <img src="/img/dominion-day.jpg" class="img-fluid" style="width: 100%;" alt="sample image">
            <div class="mask rgba-black-gradient d-md-flex align-items-end">
              <div class="text-bottom white-text p-4">
                <span class="badge badge-danger">Discover Canada Study Material</span>
                <h1 class="card-title font-weight-bold mt-2 mb-1">Canada's History</h1>
              </div>
            </div>
          </a>
        </div>
   ...
   <div class="col-md-6">
     <div class="media blue lighten-2 text-white z-depth-1 rounded">
            ...
            <div class="media-body">
              <p class="text-uppercase mt-2 mb-1 ml-3"><small>Last Practice Test Score</small></p>
              <p class="font-weight-bold mb-1 ml-3">45%</p>
              ...
              <p class="ml-3 mb-0"><small>56% increase</small></p>
            </div>
          </div>
   </div>
   <div class="col-md-6">
      <div class="media pink lighten-2 text-white z-depth-1 rounded">
            ...
            <div class="media-body">
              <p class="text-uppercase mt-2 mb-1 ml-3"><small>Assessment Rating</small></p>
              <h3 class="font-weight-bold mb-1 ml-3">Marginal</h3>
...
<div class="row" style="padding-top: 30px;">
            ...
            <div class="col-md-12">
                ...
                <div class="content-section">
					...
					<p>
					When Europeans explored Canada they found all regions occupied by native peoples they called Indians, because the first explorers thought they had reached the East Indies. The native people lived off the land, some by hunting and gathering, others by raising crops. The <mark class="mark4" data-source="Where did the Huron-Wendat live and how did they survive?">Huron-Wendat</mark> of the Great Lakes region, like the Iroquois, were farmers and hunters. The <mark class="mark4" data-source="Where did the Cree and Dene live? Did they farm?">Cree and Dene</mark> of the Northwest were hunter-gatherers. The <mark class="mark4" data-source="What animal did the Sioux hunt?">Sioux</mark> were nomadic, following the bison (buffalo) herd. The <mark class="mark4" data-source="Where did the Inuit live?">Inuit</mark> lived off Arctic wildlife. <mark class="mark4" data-source="How were fish preserved?">West Coast natives</mark> preserved fish by drying and smoking. Warfare was common among <mark class="mark4" data-source="Were aboriginals peaceful?">Aboriginal groups as they competed for land, resources and prestige.
</p><p>
The arrival of European traders, missionaries, soldiers and colonists changed the native way of life forever. Large numbers of <mark class="mark4">Aboriginals died of European diseases</mark> to which they lacked immunity. However, Aboriginals and Europeans formed strong economic, religious and military bonds in the first 200 years of coexistence which laid the foundations of Canada.
		</p>
		
		<h2>The First Europeans
</h2>
					<p>
				The <mark class="mark4">Vikings</mark> from Iceland who colonized Greenland 1,000 years ago also reached <mark class="mark3">Labrador and the island of Newfoundland</mark>. The remains of their settlement, l’Anse aux Meadows, are a World Heritage site.
</p><p>
European exploration began in earnest in 1497 with the expedition of John Cabot, who was the first to draw a map of Canada’s East Coast.
		...
		<p>
Between <mark class="mark1">1534 and 1542</mark>, <mark class="mark">Jacques Cartier</mark> made three voyages across the Atlantic, claiming the land for <mark class="mark2">King Francis I of France</mark>. Cartier heard two captured guides speak the Iroquoian word <mark class="mark3">kanata</mark>, meaning “village.” By <mark class="mark1">the 1550s</mark>, the name of Canada began appearing on maps.


		</p>
<h2>Royal New France
</h2><p>
n 1604, the first European settlement north of Florida was established by French explorers Pierre de Monts and Samuel de Champlain, first on St. Croix Island (in present-day Maine), then at Port-Royal, in Acadia (present-day Nova Scotia). In 1608 Champlain built a fortress at what is now Québec City. The colonists struggled against a harsh climate. Champlain allied the colony with the Algonquin, Montagnais, and Huron, historic enemies of the Iroquois, a confederation of five (later six) First Nations who battled with the French settlements for a century. The French and the Iroquois made peace in 1701.
</p><p>
The French and Aboriginal people collaborated in the vast fur-trade economy, driven by the demand for beaver pelts in Europe. Outstanding leaders like Jean Talon, Bishop Laval, and Count Frontenac built a French Empire in North America that reached from Hudson Bay to the Gulf of Mexico.
		...
		<h2>Struggle for a New Continent</h2>
		<p>
...
English colonies along the Atlantic seaboard, dating from the early 1600s, eventually became richer and more populous than New France. In the 1700s France and Great Britain battled for control of North America. In 1759, the British defeated the French in the Battle of the Plains of Abraham at Québec City — marking the end of France’s empire in America. The commanders of both armies, Brigadier James Wolfe and the Marquis de Montcalm, were killed leading their troops in battle.
		...
		<h2>A Tradition of Accommodation</h2>
		<p>To better govern the French Roman Catholic majority, the British Parliament passed the Quebec Act of 1774. One of the constitutional foundations of Canada, the Quebec Act accommodated the principles of British institutions to the reality of the province. It allowed religious freedom for Catholics and permitted them to hold public office, a practice not then allowed in Britain. The Quebec Act restored French civil law while maintaining British criminal law.

</p>
  <div class="row d-flex justify-content-center px-md-5 mx-md-5 text-center dark-grey-text" style="padding-top: 20px;padding-bottom: 20px;">
<!-- Card -->
<div class="card card-image" style="background-image: url(https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%2814%29.jpg);">
  ...
  <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
    <div>
      <h5 class="pink-text"><i class="fas fa-chart-pie"></i> Mid-section Review</h5>
      <h3 class="card-title pt-2"><strong>Flashcard Break</strong></h3>
      <p>Twenty flashcard questions to aid in memorizing the section material presented thus far.</p>

<a class="btn btn-danger btn-md ml-0 mb-5" data-toggle="modal" data-target="#basicExampleModal">Start now<i class="fa fa-magic ml-2"></i></a>
    </div>
  </div>
...
In 1776, the 13 British colonies to the south of Quebec declared independence and formed the United States. North America was again divided by war. More than 40,000 people loyal to the Crown, called “Loyalists,” fled the oppression of the American Revolution to settle in Nova Scotia and Quebec. Joseph Brant led thousands of Loyalist Mohawk Indians into Canada. The Loyalists came from Dutch, German, British, Scandinavian, Aboriginal and other origins and from Presbyterian, Anglican, Baptist, Methodist, Jewish, Quaker, and Catholic religious backgrounds. About 3,000 black Loyalists, freedmen and slaves, came north seeking a better life. In turn, in 1792, some black Nova Scotians, who were given poor land, moved on to establish Freetown, Sierra Leone (West Africa), a new British colony for freed slaves.
      ...
      <!--Grid row-->
    <div class="media" style="border: 1px solid #d4d4d4; border-radius: 5px; padding: 15px; margin-bottom: 20px;">
  ...
  <div class="media-body">
    ...
    <p>Democratic institutions developed gradually and peacefully. The first representative assembly was elected in Halifax, Nova Scotia, in 1758. Prince Edward Island followed in 1773, New Brunswick in 1785. The Constitutional Act of 1791 divided the Province of Quebec into Upper Canada (later Ontario), which was mainly Loyalist, Protestant and English-speaking, and Lower Canada (later Quebec), heavily Catholic and French-speaking.
</p>
    <p>The Act also granted to the Canadas, for the first time, legislative assemblies elected by the people. The name Canada also became official at this time and has been used ever since. The Atlantic colonies and the two Canadas were known collectively as British North America.</p>

  </div>
</div>
		
                
				<h2>Abolition of Slavery
</h2><p>
...
The basic way of life in English-speaking areas was established by hundreds of thousands of English, Welsh, Scottish and Irish settlers, soldiers and migrants from the 1600s to the 20th century. Generations of pioneers and builders of British origins, as well as other groups, invested and endured hardship in laying the foundations of our country. This helps explain why Anglophones (English speakers) are generally referred to as English Canadians.
  ...
  <img class="d-flex align-self-start mr-3" src="https://mdbootstrap.com/img/Photos/Others/placeholder6.jpg" alt="Generic placeholder image">
  <div class="media-body">
    <h5 class="mt-0 font-weight-bold">Becoming Canadian</h5>
    <p>Some Canadians immigrate from places where they have experienced warfare or conflict. Such experiences do not justify bringing to Canada violent, extreme or hateful prejudices. In becoming Canadian, newcomers are expected to embrace democratic principles such as the rule of law.
...
<div class="card card-image" style="background-image: url(https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%2814%29.jpg);">
  ...
  <div class="text-white text-center d-flex align-items-center rgba-black-strong py-5 px-4">
    <div>
      <h5 class="pink-text"><i class="fas fa-chart-pie"></i> End-section Review</h5>
      <h3 class="card-title pt-2"><strong>Flashcard Break</strong></h3>
      <p>Twenty flashcard questions to aid in memorizing the second half section material.</p>
...
Non-official languages are ly spoken in Canadian homes. Chinese languages are the second most-spoken at home, after English, in two of Canada’s biggest cities. In Vancouver, 13% of the population speak Chinese languages at home; in Toronto, the number is 7%.
</p><p>
...
<hr>
    <div class="row pr-lg-5">
      <div class="col-md-4 mb-4">
        ...
        <div class="view">
          <img src="/img/testfinal.svg" class="img-fluid" alt="smaple image">
        </div>
      ...
      <div class="col-md-8 d-flex align-items-center">
        <div>
          ...
          <h3 class="font-weight-bold mb-4">Sectional Study</h3>
        	...
        	<button type="button" class="btn btn-orange btn-rounded mx-0"> Practice Test</button>         	<button type="button" class="btn btn-orange btn-rounded mx-0">Next Section</button>
...
$(".peoples").click(function(){
	if($(this).hasClass('active')){
		 $('.mark4').removeClass('bg-danger');
  $(this).removeClass('active');
  $('.mark4').css('color', '#333');
	} else {
  $('.mark4').addClass('bg-danger');
  $(this).addClass('active');
  $('.mark4').css('color', 'white');
	}
