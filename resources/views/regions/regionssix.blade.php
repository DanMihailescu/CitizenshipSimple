...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
            ...
            <small><span><strong>6</strong></span>/<span></span>6</small>
		  </div>
          <div class="progress lg-progress">
          <div id="progressbar" class="progress-bar bg-danger animated flash" style="width: 83%;" role="progressbar"></div>
          </div>
...
<div class="text-right"> <button type="button" class="btn btn-danger btn-rounded
 nextbutton">Next <i class="fas fa-magic mr-1"></i></button> 
...
<div style="margin-bottom: 100px;">
  ...
  <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed the Canada's Regions section of the Discover Canada guide. Keeping going!.</p>
...
$('#progressbar').animate({ width: "100%"}, 1000);	
        ...
        $.ajax({
           ...
           data:{"module": 11, "section":6, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"regions"},
