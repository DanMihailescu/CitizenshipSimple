...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Canada's Regions</title>
...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
	...
	<h1 class="pink-text" style="font-weight: bold;">Canada's Regions</h1>
...
<ul>
<li>The Atlantic Provinces
</li>
<li>Central Canada
</li>
<li>The Prairie Provinces
</li>
<li>The West Coast
</li>
<li>The Northern Territories
</li>
</ul>
<h2 style="font-weight: normal; font-size: 1.5em;padding-top: 0px;" >
...
<p>Ottawa, located on the Ottawa River, was chosen as the capital in 1857 by Queen Victoria, the great-great-grandmother of Queen Elizabeth II. Today it is Canada’s fourth largest metropolitan area. The National Capital Region, 4,700 square kilometres surrounding Ottawa, preserves and enhances the area’s built heritage and natural environment.
...
Canada has a population of about 34 million people. While the majority live in cities, Canadians also live in small towns, rural areas and everywhere in between.
 ...
 <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed your first section on Canada's Regions. Keeping going, or save your progress for later.</p>
    
       <a href="/discover-canada" class="btn btn-deep-purple btn-rounded">Save and Exit</a>
 <a href="/regions/regions-two" class="btn btn-danger btn-rounded">Continue Training</a>
  ...
  $('#next').on('click', function (e) {
    ...
    if (isNaN(selections[questionCounter])) {
	  ...
	  $('#warning').text('');
			...
			$('#progressbar').animate({ width: "12%"}, 1000);		
   $.ajax({

           type:'POST',
           url:'/discoverytrackpost',
           data:{"module": 11, "section":1, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"regions-two"},
