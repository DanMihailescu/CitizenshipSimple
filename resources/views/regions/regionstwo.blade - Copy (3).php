 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
          ...
          <div class="progress lg-progress">
            <div id="progressbar" class="progress-bar bg-danger animated flash" style="width: 12%;" role="progressbar"></div>
          </div>
...
Situated in the Appalachian Range, the province was founded by the United Empire Loyalists and has the second largest river system on North America’s Atlantic coastline, the St. John River system. Forestry, agriculture, fisheries, mining, food processing and tourism are the principal industries. Saint John is the largest city, port and manufacturing centre; Moncton is the principal Francophone Acadian centre; and Fredericton, the historic capital. New Brunswick is the only officially bilingual province, and about one-third of the population lives and works in French. The province’s pioneer Loyalist and French cultural heritage and history come alive in street festivals and traditional music.
 ...
 <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed your second section on Canadian Regions. Keeping going, or save your progress for later.</p>
    
       <a href="/discover-canada" class="btn btn-deep-purple btn-rounded">Save and Exit</a>
 <a href="/regions/regions-three" class="btn btn-danger btn-rounded">Continue Training</a>
  ...
  $('#next').on('click', function (e) {
    ...
    if (isNaN(selections[questionCounter])) {
	  ...
	  $('#warning').text('');
			...
			$('#progressbar').animate({ width: "24%"}, 1000);		
   $.ajax({

           type:'POST',
           url:'/discoverytrackpost',
           data:{"module": 11, "section":2, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"regions-three"},
