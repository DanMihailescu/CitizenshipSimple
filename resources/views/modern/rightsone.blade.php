...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
	...
	<h1 class="pink-text" style="font-weight: bold;">Modern Canada</h1>
   <div class="d-flex justify-content-between progressbar">
            <small class="text-muted">Section Progress</small>
            <small><span><strong>1</strong></span>/<span></span>6</small>
          </div>
...
Canada joined international organizations such as the United Nations (UN). It participated in the UN operation defending South Korea in the Korean War (1950–53), with 500 dead and 1,000 wounded. Canada has taken part in numerous UN peacekeeping missions in places as varied as Egypt, Cyprus and Haiti, as well as in other international security operations such as those in the former Yugoslavia and Afghanistan.
		 ...
		 <div class="text-right"> <button type="button" class="btn btn-danger btn-rounded nextbutton">Next <i class="fas fa-magic mr-1"></i></button>  </d
 ...
 <a href="/modern/modern-three" class="btn btn-danger btn-rounded">Continue Training</a>
