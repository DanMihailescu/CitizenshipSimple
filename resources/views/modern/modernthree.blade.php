...
<div style="margin-bottom: 100px;">
  ...
  <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed the Modern Canada section of the Discover Canada guide. Keeping going!.</p>
...
$('#progressbar').animate({ width: "75%"}, 1000);	
        ...
        $.ajax({
           ...
           data:{"module": 5, "section":3, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"defending-canada"},
