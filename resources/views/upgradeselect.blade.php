...
<head>
  <meta charset="utf-8">
  <title>CitizenshipSimple: Choose Upgrade Option</title>
...
<h1 class="text-center animated fadeIn dark-grey-text" style="font-family: lobster">Welcome Aboard <?php echo Auth::user()->name ?>!</h1>
<p class="h3 grey-text text-center animated fadeIn" style="font-family: 'Lobster';">You can choose the free, limited version, or pay $19 for the full version.</p>
...
<div class="card animated fadeIn" style="border: 5px solid #ececec;border-radius: 15px;">
     <div class="card-body text-center">
	 			<i class="fas fa-battery-quarter fa-3x grey-text"></i>

            <div class="step-number text-center">
			              <h5 class="grey-text">Free</h5>
              <h3 class="grey-text">Limited</h3>
            </div>
            <div class="step-excerpt text-center">
              <p class="text-muted">Limited Version applicants are <b>less prepared</b> to pass the Citizenship Test. There is no guarantee of success.</p>

			<div class="row">
			<div class="col-3">
  <ul class="text-right">
              <li class=" h6 mt-2">
                <p ><i class="fas fa-check canada-text pr-2"></i></p>
              </li>
              <li class=" h6 mt-2">
                <p><i class="fas fa-check canada-text pr-2"></i></p>
              </li>
              <li class=" h6 mt-2">
                <p><i class="fas fa-times grey-text pr-2"></i></p>
              </li>
              <li class=" h6 mt-2">
                <p><i class="fas fa-times grey-text pr-2"></i></p>
              </li>
              <li class=" h6 mt-2">
			   ...
			   <li class=" h6 mt-2">
                <p><i class="fas fa-times grey-text pr-2"></i><br><br></p>
              </li>
			   <li class=" h6 mt-2">
                <p><i class="fas fa-times grey-text pr-2"></i></p>
              </li>
...
<div class="col-9">
<ul class="text-left">
              <li class="mt-2 h6 canada-text">
                <p >80 Citizenship Test Questions</p>
              </li>
              <li class="mt-2 h6 canada-text">
                <p>Easy Mode</p>
              </li>
              <li class="mt-2 h6 grey-text">
                <p>Moderate Mode</p>
              </li>
              <li class="mt-2 h6  grey-text">
                <p>Hard Mode</p>
              ...
              <li class="mt-2 h6 grey-text">
                <p>Analytics (<span class="canada-text">Limited</span>) </p>
              </li>
			   <li class="mt-2 h6  grey-text">
                <p>Chapter Tests (<span class="canada-text">Only One Active</span>)</p>
              </li>
			   <li class="mt-2 h6  grey-text">
                <p>Official Study Guide (<span class="canada-text">Only Three Active</span>)</p>
              </li>
            </ul>     
</div>
</div>
			</div>
			<a class="btn btn-lg btn-grey btn-rounded"  href="/home">Upgrade Later</a>
         </div>
		 </div>
		 <div class="card card-button animated fadeIn" style="">
		 <div class="card-body text-center">
          <i class="fas fa-battery-full fa-3x canada-text"></i>

            <div class="step-number text-center">
						              <h5 class="canada-text">$19</h5>

              <h3 class=" canada-text ">Full Version</h3>
            </div>
            <div class="step-excerpt text-center">
              <p class="text-muted">Full Version applicants are <b>guaranteed</b> to pass the Citizenship Test, or the one-time charge is refunded.</p>
  <div class="row">
			<div class="col-3">
  <ul class="text-right">
              <li class=" h6 mt-2">
              ...
              <li class=" h6 mt-2">
			   ...
			   <li class=" h6 mt-2">
                <p><i class="fas fa-check canada-text pr-2"></i><br><br></p>
              </li>
			   <li class=" h6 mt-2">
                <p><i class="fas fa-check canada-text pr-2"></i></p>
              </li>
...
<ul class="text-left">
              <li class="mt-2 h6 canada-text">
                <p><u>750</u> Citizenship Test Questions</p>
              </li>
              <li class="mt-2 h6 canada-text">
                <p>Easy Mode</p>
              </li>
              ...
              <li class="mt-2 h6 canada-text">
                <p>Analytics (<span class="canada-text">Full</span>) </p>
              </li>
			   <li class="mt-2 h6  canada-text">
                <p>Chapter Tests (<span class="canada-text">With All Ten Active</span>)</p>
              </li>
			   <li class="mt-2 h6  canada-text">
                <p>Official Study Guide (<span class="canada-text">All Ten Active</span>)</p>
              </li>
            </ul>     
</div>
</div>
		   </div>
						<a class="btn btn-lg btn-canada btn-rounded" style="color: #fff;" href="/home">Get Fully Prepared!</a>
