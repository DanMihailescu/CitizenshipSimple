...
<head>
  <meta charset="utf-8">
  <title>CitizenshipSimple: Easy Practice Test Start</title>
...
<div class="col-6">           
		  <a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-danger btn-flat text-light" style="margin-top: 37px;margin-bottom: 20px;">Exit <i class="fas fa-external-link-alt"></i></a>
...
<div class="card animated fadeIn" style="border: 5px solid #ececec;border-radius: 15px;">
     <div class="card-body text-center">
			...
			<a class="btn btn-lg btn-danger" style="color: #fff;" href="/practice-test-with-answers?number=10&test=1&test_type=1">Begin Zip Test</a>
         </div>
		 </div>
          ...
          <i class="fas fa-clock fa-3x text-danger"></i>
            ...
            <div class="step-excerpt text-center" style="margin-top: 15px;">
              <p class="text-muted">The <b>full 20 Question Timed</b> Test. Must be completed within 30 minutes.</p>
						...
						<a class="btn btn-lg btn-danger" style="color: #fff;" href="/timed-test?number=20&test=2&test_type=1">Begin Simulation</a>
