...
@-webkit-keyframes pulse {
  0% {
    -webkit-box-shadow: 0 0 0 0 rgba(198,40,40, 0.4);
  }
  70% {
      -webkit-box-shadow: 0 0 0 10px rgba(198,40,40,44, 0);
  }
  100% {
      -webkit-box-shadow: 0 0 0 0 rgba(198,40,40,44, 0);
  }
}
@keyframes pulse {
  0% {
    -moz-box-shadow: 0 0 0 0 rgba(198,40,40, 0.4);
    box-shadow: 0 0 0 0 rgba(198,40,40, 0.4);
  }
  70% {
      -moz-box-shadow: 0 0 0 10px rgba(204,1198,40,40, 0);
...
<div class="container" style="padding-top: 40px;padding-bottom: 0!important;">
      ...
      <div class="col-md-12">
            ...
            <div class="row h-100 d-flex align-items-center">
              <div class="col-lg-6">
				...
				<ul class="fa-ul mb-4 text-muted font-weight-normal">
                  <li class="mb-2"><span class="fa-li"><span class="pulse"></span></span>
 Built in GPS</li>
