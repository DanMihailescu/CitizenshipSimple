...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
            ...
            <small><span><strong>2</strong></span>/<span></span>2</small>
          </div>
...
<p>
<b>Obeying the law</b> — One of Canada’s founding principles is the rule of law. Individuals and governments are regulated by laws and not by arbitrary actions. No person or group is above the law.
</p>
<p>
<b>Taking responsibility for oneself and one’s family</b> — Getting a job, taking care of one’s family and working hard in keeping with one’s abilities are important Canadian values. Work contributes to personal dignity and self-respect, and to Canada’s prosperity.
</p>
<p>
<b>Serving on a jury</b> — When called to do so, you are legally required to serve. Serving on a jury is a privilege that makes the justice system work as it depends on impartial juries made up of citizens.
</p>
<p>
<b>Voting in elections</b> — The right to vote comes with a responsibility to vote in federal, provincial or territorial and local elections.
</p>
<p>
<b>Helping others in the community</b> — Millions of volunteers freely donate their time to help others without pay—helping people in need, assisting at your child’s school, volunteering at a food bank or other charity, or encouraging newcomers to integrate. Volunteering is an excellent way to gain useful skills and develop friends and contacts.
</p>
<p>
...
You may also serve in the Coast Guard or emergency services in your community such as a police force or fire department. By helping to protect your community, you follow in the footsteps of Canadians before you who made sacrifices in the service of our country.
 ...
 nextbutton">Next <i class="fas fa-magic mr-1"></i></button>  </div>
  ...
  <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed the Rights and Responsibilities section of the Discover Canada guide. Keeping going!.</p>
    
 <a href="/discover-canada" class="btn btn-danger btn-rounded">Continue Training</a>
...
$('#progressbar').animate({ width: "50%"}, 1000);	
        ...
        $.ajax({
           ...
           data:{"module": 2, "section":2, "completion":"no", "_token": "{{ csrf_token() }}", "nextsec":"rights"},
