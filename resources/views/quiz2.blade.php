...
<body class="loader" data-spy="scroll" data-target="#toc">
...
<div class="list" style="display:none;">
   ...
   <hr>
	...
	<h2>Excellent</h2>
	<h4>The knowledge level displayed in your exam performance indicates an excellent opportunity to pass the official citizenship test.
</div><div class="col-2">
	   <svg class="circle-chart" viewbox="0 0 33.83098862 33.83098862" width="200" height="200" xmlns="http://www.w3.org/2000/svg">
      <circle class="circle-chart__background" stroke="#efefef" stroke-width="2" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" />
      <circle class="circle-chart__circle" stroke="#ff4444" stroke-width="2" stroke-dasharray="90,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" />
      <g class="circle-chart__info">
        <text class="circle-chart__percent" x="16.91549431" y="15.5" alignment-baseline="central" text-anchor="middle" font-size="7">90%</text>
        <text class="circle-chart__subline" x="16.91549431" y="20.5" alignment-baseline="central" text-anchor="middle" font-size="2">Yay 90% progress!</text>
      </g>
    </svg>
	</div>
	</div>
	...
	<h4>Your score is <b>10% higher</b> than your last 4 test performances. You are showing improvement.</h4>
	</div>
	</div>
	...
	<h4>Congratulations, you added <b><span class="point">8</span> points </b>to your total through your correct answers. Your rank on the weekly Canadian Leaderboard is now <b>91st</b>.
	  </span></div>
	  <div class="col-6">
<ul class="list-group">
  <li class="list-group-item ">
    <div class="md-v-line"></div><b>89</b> Crandle Bing
  </li>
  <li class="list-group-item">
    <div class="md-v-line"></div><b>90</b> Daphne Tabelo
  </li>
  <li class="list-group-item bg-danger text-white">
    <div class="md-v-line"></div><b>91</b> Your Rank
  </li>
  <li class="list-group-item">
    <div class="md-v-line"></div><b>92</b> Michael Bloombereg
  </li>
  <li class="list-group-item">
    <div class="md-v-line"></div><b>93</b> John Van Saint Anna
  </li>
</ul>
	</div>
...
<div style="text-align: left;"> 
  ...
  <div class="col-6 p-3">
  <div style="text-align: right;"><button class="btn btn-grey btn-lg btn-rounded" id="next">Check Answer</button>
</div>
  </div>
 </div>
 </div>
 ...
 <p class="showanswer" style="color: #fff;"></p>
 </div>
 <div class="col-3 p-3">
    <button class="btn btn-outline-white btn-lg btn-rounded nextq">Next Question</button>
