...
<section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed your tenth section on Canadian History. Keeping going, or save your progress for later.</p>
  ...
  $('#next').on('click', function (e) {
    ...
    if (isNaN(selections[questionCounter])) {
	  ...
	  $('#warning').text('');
			...
			$('#progressbar').animate({ width: "83%"}, 1000);		
   $.ajax({

           type:'POST',
           url:'/discoverytrackpost',
           data:{"module": 4, "section":10, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"history-eleven"},
