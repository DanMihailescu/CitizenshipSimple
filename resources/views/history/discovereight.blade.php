...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
            ...
            <small><span><strong>8</strong></span>/<span></span>12</small>
          </div>
          <div class="progress lg-progress">
            <div id="progressbar" class="progress-bar bg-danger animated flash" style="width: 58%;" role="progressbar"></div>
          </div>
...
<section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed your eighth section on Canadian History. Keeping going, or save your progress for later.</p>
    
       <a href="/discover-canada" class="btn btn-deep-purple btn-rounded">Save and Exit</a>
 <a href="/canadas-history/history-nine" class="btn btn-danger btn-rounded">Continue Training</a>
  ...
  $('#next').on('click', function (e) {
    ...
    if (isNaN(selections[questionCounter])) {
	  ...
	  $('#warning').text('');
			...
			$('#progressbar').animate({ width: "66%"}, 1000);		
   $.ajax({

           type:'POST',
           url:'/discoverytrackpost',
           data:{"module": 4, "section":8, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"history-nine"},
