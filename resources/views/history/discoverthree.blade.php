...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
            ...
            <small><span><strong>3</strong></span>/<span></span>12</small>
          </div>
...
The French and Aboriginal people collaborated in the vast fur-trade economy, driven by the demand for beaver pelts in Europe. Outstanding leaders like Jean Talon, Bishop Laval, and Count Frontenac built a French Empire in North America that reached from Hudson Bay to the Gulf of Mexico.</p><p>
		</p>
 ...
 <a href="/canadas-history/struggle-for-a-continent" class="btn btn-danger btn-rounded">Continue Training</a>
...
$('#progressbar').animate({ width: "25.00%"}, 1000);		
   $.ajax({
           ...
           data:{"module": 3, "section":3, "completion":"no", "_token": "{{ csrf_token() }}", "nextsec":"struggle-for-a-continent"},
