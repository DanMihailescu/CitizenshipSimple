...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
            ...
            <small><span><strong>2</strong></span>/<span></span>12</small>
          </div>
          <div class="progress lg-progress">
            <div id="progressbar" class="progress-bar bg-danger animated flash" style="width: 8.33%;" role="progressbar"></div>
          </div>
...
<div style="width: 100%;height: 100px;"></div>
 ...
 <a href="/canadas-history/royal-new-france" class="btn btn-danger btn-rounded">Continue Training</a>
...
$('#progressbar').animate({ width: "8.33%"}, 1000);		
   $.ajax({
           ...
           data:{"module": 2, "section":4, "completion":"no", "_token": "{{ csrf_token() }}", "nextsec":"first-europeans"},
