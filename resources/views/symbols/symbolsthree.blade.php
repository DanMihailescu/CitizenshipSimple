...
The beaver was adopted centuries ago as a symbol of the Hudson’s Bay Company. It became an emblem of the St. Jean Baptiste Society, a French-Canadian patriotic association, in 1834, and was also adopted by other groups. This industrious rodent can be seen on the five-cent coin, on the coats of arms of Saskatchewan and Alberta, and of cities such as Montreal and Toronto.
 ...
 <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed your third section on Canadian Symbols. Keeping going, or save your progress for later.</p>
    
       <a href="/discover-canada" class="btn btn-deep-purple btn-rounded">Save and Exit</a>
 <a href="/symbols/symbols-four" class="btn btn-danger btn-rounded">Continue Training</a>
...
function playApplause() {
  ...
  $('#next').on('click', function (e) {
   ...
   $.ajax({
           ...
           data:{"module": 9, "section":3, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"symbols-four"},
