...
The provincial legislatures are architectural treasures. The Quebec National Assembly is built in the French Second Empire style, while the legislatures of the other provinces are Baroque, Romanesque and neoclassical, reflecting the Greco-Roman heritage of Western civilization in which democracy originated.
 ...
 <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed your second section on Canadian Symbols. Keeping going, or save your progress for later.</p>
    
       <a href="/discover-canada" class="btn btn-deep-purple btn-rounded">Save and Exit</a>
 <a href="/symbols/symbols-three" class="btn btn-danger btn-rounded">Continue Training</a>
...
function playApplause() {
  ...
  $('#next').on('click', function (e) {
   ...
   $.ajax({
           ...
           data:{"module": 9, "section":2, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"symbols-three"},
