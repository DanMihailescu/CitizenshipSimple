...
Parliament passed the Official Languages Act in 1969. It has three main objectives:</p><p>
</p>
...
<div style="margin-bottom: 100px;">
  ...
  <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed the Canadian Symbols section of the Discover Canada guide. Keeping going!.</p>
...
$('#progressbar').animate({ width: "100%"}, 1000);	
        ...
        $.ajax({
           ...
           data:{"module": 9, "section":4, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"symbols"},
