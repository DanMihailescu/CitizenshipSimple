...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Untimed Exam</title>
...
.underline {
  ...
  background-image: linear-gradient(to right, lightgreen 0, yellow 100%);
  ...
  &--gradient {
    background-position: 0 -0.1em;
    background-image: linear-gradient(to right, yellow 0, lightgreen 50%);
  }
  &--reverse {
...
.checksmall {display: none;}
.startchecksmall {display: none;}
.correctsmall {display:none;}
.topcontain {padding-top: 20px;}
@media (max-width: 544px) {  
  h3 {font-size:1.35rem;}
  .check {height: 80px;}
  .startcheck {height: 80px;}
  .startcheckbig {display: none;}
  .startchecksmall {display: inline;}
.checkbig {display:none;}
.correctbig {display:none;}
.correctsmall {display: inline;}

.topcontain {padding-top: 0;}
.checksmall {display: inline;}
  /*1rem = 16px*/
}
</style>
...
<div class="col-6">
<button id="clap" class="clap" disabled>
  <span>
...
<div id="multi-item-example" class="carousel slide carousel-multi-item list" style="border:none; box-shadow: none;data-ride="carousel">
...
<div class="" style="min-height: 450px;text-align: center;padding-top: 50px;align: center;">
 
	  
<div class="row" style="padding-bottom: 25px;"><div class="col-lg-2"></div><div class="col-lg-8">	  
      ...
      <circle class="circle-chart__circle" stroke="#ff5555" stroke-width="2" stroke-dasharray="80,100" stroke-linecap="round" fill="none" cx="16.91549431" cy="16.91549431" r="15.91549431" />
      <g class="circle-chart__info">
      <text class="circle-chart__percent" x="16.91549431" y="17" alignment-baseline="central" text-anchor="middle" font-size="8" fill="#FF5555"></text>
        <text class="circle-chart__subline" x="16.91549431" y="20.5" alignment-baseline="central" text-anchor="middle" font-size="2"></text>
      </g>
    </svg>

	<h1 class="evaluate" style="font-weight: bold;color: #ff5555;font-family: 'Lobster';"></h1>
	<h4 class="evaldes" style="color: #ff5555;">
</div>
<div class="col-lg-2">
</div>
</div>
...
<div class="container">
<div class="col-md-12 align-center text-center" style="">
<div style="min-height: 450px;padding-top: 50px;">
	<img src="" class="rank" style="max-width: 250px;margin: auto;" />
	<h1 class="rank_title" style="font-family: 'Lobster';"></h1>
	<h5 style="font-family: 'Lobster';">Ranked Earned</h5>
	<h4>Congratulations, you racked up <span class="point">8</span> points! <span class="encourage"></span>
	</h4>
	</div>
	</div>
	</div>
...
<div class="col-md-12 align-center text-center" style="">
<div style="min-height: 450px;padding-top: 50px;">
<i class="fas fa-chart-line red-text fa-5x"></i>
	<h1 style="font-family: 'Lobster';">Dashboard Updated</h1>
	<h4 style="font-family: 'Lobster';">Progress Charts & Learning Tools Refreshed</h5>
	<p>Your result has helped update tools to track and improve your progress, return to the dashboard to continue practicing.
	</p>
	<a href="/home" class="btn btn-lg text-white btn-danger btn-rounded">Dashboard</a>
	</div>
	</div>
	</div>
    </div>
...
<section class="content p-3" id="quiz">

 </section>
</div>
<div class="col-lg-3"></div>
</div>
 <div id="belowquiz"></div>
 
</div>
</div>
 <div class="startcheck">
<div class="container">
 <div class="row startcheckbig">
  <div class="col-6">
<div style="text-align: left;"> 
  ...
  <div class="col-6 p-3">
  <div style="text-align: right;"><button class="btn btn-grey btn-lg btn-rounded next" >Check Answer</button>
</div>
  </div>
 </div>
 
 
  <div class="row startchecksmall">
  <div class="col-12">
  <div style="padding: 0; margin-top: -10px;text-align: right;"><button class="btn btn-grey btn-md btn-rounded next" >Check Answer</button>
</div>
  </div>
 </div>
 </div>
 ...
 <div class="check">
 <div class="container">
 <div class="row checkmark" style="display:none;">
 <div class="col-12">
 <div class="correctsmall">
 <div class="row">
 
 <div class="col-3 p-3 thumbsup">
		...
		<svg viewBox="0 0 87 87" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
				<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						<g id="Group-3" transform="translate(2.000000, 2.000000)">
							<circle id="Oval-2" stroke="rgba(255, 255, 255, 0.2)" stroke-width="4" cx="41.5" cy="41.5" r="41.5"></circle>
								<circle  class="ui-success-circle" id="Oval-2" stroke="#FFFFFF" stroke-width="4" cx="41.5" cy="41.5" r="41.5"></circle>
								<polyline class="ui-success-path" id="Path-2" stroke="#FFFFFF" stroke-width="4" points="19 38.8036813 31.1020744 54.8046875 63.299221 28"></polyline>
						</g>
				</g>
		</svg>
	</div>
 ...
 <div class="col-9 p-3 text-right">
    <button class="btn btn-outline-white btn-md btn-rounded nextq">Next Question</button>

 </div>
 </div>
 </div>
 
 <div class="correctbig">
 <div class="row">
 
 <div class="col-1 p-3 thumbsup">
		<div class="ui-success">
		<svg viewBox="0 0 87 87" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
				<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						<g id="Group-3" transform="translate(2.000000, 2.000000)">
 ...
 <div class="col-7 p-3">
 <h3 style="color: #fff;font-weight: bold;">Correct!</h3>
 
 </div>
 <div class="col-4 p-3 text-right">
    <button class="btn btn-outline-white btn-lg btn-rounded nextq">Next Question</button>
  ...
  <div class="row checkwrong" style="display:none;">
  <div class="row checkbig">
 <div class="col-1 p-3 thumbsdown">
	<div class="ui-error">
		<svg  viewBox="0 0 87 87" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					<g id="Group-2" transform="translate(2.000000, 2.000000)">
						<circle id="Oval-2" stroke="rgba(255, 255, 255, .5)" stroke-width="4" cx="41.5" cy="41.5" r="41.5"></circle>
						<circle  class="ui-error-circle" stroke="#FFFFFF" stroke-width="4" cx="41.5" cy="41.5" r="41.5"></circle>
							<path class="ui-error-line1" d="M22.244224,22 L60.4279902,60.1837662" id="Line" stroke="#FFFFFF" stroke-width="3" stroke-linecap="square"></path>
							<path class="ui-error-line2" d="M60.755776,21 L23.244224,59.8443492" id="Line" stroke="#FFFFFF" stroke-width="3" stroke-linecap="square"></path>
					</g>
			</g>
	</svg>
	</div>
 ...
 <div class="col-7 p-3">
 <h3 style="color: #fff;font-weight: bold;">Incorrect!</h3>
 <p style="color: #fff; font-size: 1.1em;"><b>Correct Answer:</b> <span class="showanswer" style="color: #fff;"></span>
 </div>
 <div class="col-3 text-right p-3">
  ...
  <div class="row checksmall ">
 <div class="col-12">
 <div class="row">

 <div class="col-3 thumbsdown p-3">
	<div class="ui-error">
		<svg  viewBox="0 0 87 87" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
			<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					<g id="Group-2" transform="translate(2.000000, 2.000000)">
 ...
 <div class="col-9 text-right p-3" style="text-align: right;">
    <button class="btn btn-outline-white btn-md btn-rounded nextq" style="float: right;">Next Question</button>
  ...
  <!-- Copyright -->
  <input type="hidden" id="test_points" name="test_points" value="<?php echo $_GET['test_type'];?>" />

<input type="hidden" id="test_type" name="test_type" value="<?php echo $_GET['test'];?>" />
<input type="hidden" id="test_score" name="test_score" value="<?php 
if($_GET['test'] == 1) { 
if(isset($points->easyshort) && $points->easyshort != null) { echo $points->easyshort; } else { echo 0;} 
} elseif ($_GET['test'] == 2) { 
if(isset($points->easylong) && $points->easylong != null) { 
echo $points->easylong; 
} else { 
echo 0;} 
} elseif ($_GET['test'] == 3) { 
if(isset($points->mediumshort) && $points->mediumshort != null) { 
echo $points->mediumshort; } else { echo 0;} 
} elseif($_GET['test'] == 4) { if(isset($points->mediumlong) && $points->mediumlong != null) { 
echo $points->mediumlong; } else { echo 0;} 
} else { echo 0;} ?>" />
</footer>
...
labels: ["5", "4", "3", "2", "1"],
datasets: [{
label: "My Last 5 Performances",
data: [65, 59, 80, 81, 90],
backgroundColor: [
'rgba(172,147,147, 1.0)',
],
borderColor: [
'rgba(255, 255, 255, .7)',
],
...
const initialNumberOfClaps = point

const tlDuration = 300
let numberOfClaps = 0
let clapHold;
let test_type = parseInt($('#test_type').val());
...
const circleBurst = new mojs.Burst({
  ...
  children: {
    shape: 'circle',
    fill: 'rgba(149,165,166 ,0)',
    delay: 30,
    speed: 0.1,
    radius: {3: 0},
    easing: mojs.easing.bezier(0.1, 1, 0.3, 0),
  }
})
...
function updateNumberOfClaps() {
  ...
  clapTotalCount.innerHTML = parseInt(initialNumberOfClaps) + parseInt(numberOfClaps)
    $.ajax({
           type:'POST',
           url:'/postpoints',
           data:{"points": parseInt(initialNumberOfClaps) + parseInt(numberOfClaps), "_token": "{{ csrf_token() }}"},
...
$(document).ready(function(){
	...
	questions[q].correctAnswer = darray[q].correct;
...
questions[q].difficulty = darray[q].difficulty;
  ...
  displayNext();
  	var prog = 0;
 var h = ($(window).height() - 108 - 200 - $('.content').height())*0.4;
 if (h > 0) {
 $('.content').css('marginTop', h.toString() + "px");
 } else {
	  $('.content').css('marginTop', "0px");
	  	  $('h3').css('fontSize', "1.1em");
...
var element = document.getElementById('belowquiz');
var bottomPos = element.getBoundingClientRect().top + window.scrollY;
var viewHeight = bottomPos - window.innerHeight;

if(viewHeight < 90) {

$('.content').css('marginBottom', "100px");
  ...
  $('.next').on('click', function (e) {
	...
	//correct answer
     if (selections[questionCounter] + 1 === questions[questionCounter].correctAnswer) {
		 //send a point to database
				
				$('.check').show();
var ansr = '.x' + questions[questionCounter].correctAnswer - 1;	
$(ansr).addClass('underline');	
$(ansr).addClass('underline--gradient');	

				var qlength = 1/questions.length*100;
				prog = prog + qlength;
	
				  $(".progress-bar").css({width: prog.toString() + "%"});

	$('.progress-bar').addClass('flash');
			$('.progress-bar').removeClass('bg-danger');
			$('.progress-bar').addClass('bg-primary');
		 $('.ui-success-path').addClass('success-path-animation');
		$('.ui-success-circle').addClass('sucess-circle-animation');
	 $('.next').attr('disabled', true);
		$('.check').addClass('bg-info');
				$('.check').addClass('lighten-3');
			$('.checkmark').show();
						$('.check').removeClass('bounceOutDown');
			$('.check').addClass('animated');
			$('.check').addClass('bounceInUp');
			$('.thumbsup').addClass('animated');
			$('.thumbsup').addClass('bounceInLeft');
			playDing();
   repeatClapping();
		...
		$('.check').show();
	var ansr = '.x' + (questions[questionCounter].correctAnswer - 1).toString();	
...
playWrong(); 
		prog = prog + 10;
		var progr = prog.toString() + "%";
		  $(".progress-bar").css({width: prog.toString() + "%"});

		$('.ui-error-circle').addClass('error-circle-animation');
		$('.ui-error-line1').addClass('error-line1-animation');
		$('.ui-error-line2').addClass('error-line2-animation');
		$('.progress-bar').removeClass('flash');
		$('.progress-bar').addClass('flash');
		...
		$('.check').addClass('bg-danger');
				...
				$('.showanswer').text(questions[questionCounter].answerStore);
						$('.check').removeClass('bounceOutDown');
  ...
  $('.nextq').on('click', function (e) {
	  ...
	  $('.checkmark').hide();
	  $('.checkwrong').hide();
		$('.thumbsup').removeClass('animated');
		$('.thumbsup').removeClass('bounceInLeft');
		$('.check').removeClass('bounceInUp');
		$('.check').addClass('bounceOutDown');
		$('.startcheck').addClass('animated');
		$('.startcheck').addClass('bounceInUp');
  });
  ...
  function createQuestionElement(index) {
    ...
    var header = $('<label><strong>Question ' + (index + 1) + '</strong></label>');
    qElement.append(header);
    
    var question = $('<h3><strong>').append(questions[index].question);
    qElement.append(question);
        qElement.append('</strong></h3>');
  ...
  function createRadios(index) {
    ...
    if(questions[index].choices[i] != '') {
      input = '<div class=""><label for="opt' + i + '" class="radio"><input type="radio" name="answer" class="hidden" id="opt' + i + '" value=' + i + ' />  <span class="label"></span>';
      input += '<span class="ans x' + i + '">' + questions[index].choices[i] + '</span></label></div>';
  ...
  function displayNext() {
	...
	//deals with answer screen next
	quiz.addClass('animated');
	quiz.addClass('fadeOut');
	quiz.fadeOut(function() {
		$('#question').remove();
      if(questionCounter < questions.length){
        var nextQuestion = createQuestionElement(questionCounter);
		quiz.append(nextQuestion).fadeIn();
		 quiz.removeClass('fadeOut');
...
var questionlevel = i + 1;

var inp = '<div class="row d-flex text-left" style="border-bottom: 2px solid #f2f2f2;padding-top: 20px;"> \
      <div class="col-md-1"> \
	 <svg viewBox="0 0 87 87" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> \
				<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> \
						<g id="Group-3" transform="translate(2.000000, 2.000000)"> \
							<circle id="Oval-2" stroke="rgba(0, 0, 0, 0.2)" stroke-width="4" cx="41.5" cy="41.5" r="41.5"></circle> \
								<circle  class="ui-success-circle" id="Oval-2" stroke="#ff5555" stroke-width="4" cx="41.5" cy="41.5" r="41.5"></circle> \
								<polyline class="ui-success-path" id="Path-2" stroke="#ff5555" stroke-width="4" points="19 38.8036813 31.1020744 54.8046875 63.299221 28"></polyline> \
						</g> \
				</g> \
		</svg> \
	  </div> \
      <div class="col-md-5"> \
	          <p class="small grey-text" style="margin-bottom: 0;">Question ' + questionlevel + '</p> \
        <h6 class="font-weight-normal"><a class="dark-grey-text" href="#">' + questions[i].question + '</a></h6> \
      </div> \
      <div class="col-md-3"> \
	  	          <p class="small grey-text" style="margin-bottom: 0;">Your Selection</p> \
        <p class="text-muted mb-5 pb-2">' + questions[i].choices[selections[i]] + '</p>\
      </div> \
 <div class="col-md-3"> \
	  	          <p class="small grey-text" style="margin-bottom: 0;">Correct Answer</p> \
        <p class="text-muted mb-5 pb-2"> ' + questions[i].choices[questions[i].correctAnswer] + '</p> \
      </div> \
	  </div>';
	  $('.resultrow').append(inp);
    }
	...
	test_type = parseInt(test_type);
	 $.ajax({
           type:'POST',
           url:'/scoresave',
           data:{"score": percent, "test": test_type, "_token": "{{ csrf_token() }}"},
           error: function(jqXHR, textStatus, errorThrown) {
           alert('An error occurred... Look at the console (F12 or Ctrl+Shift+I, Console tab) for more information!');
            },
           success:function(data){
	...
	var pointTotal = parseInt(initialNumberOfClaps) + parseInt(numberOfClaps);
 if (pointTotal < 30) {
		
		$('.rank').attr('src', '/img/bronze.svg');
		$('.point').text(numberOfClaps);
			    $('.rank_title').text('Bronze');
var point_remaining = 30 - pointTotal;
$('.encourage').text('You are only ' + point_remaining + ' points away from getting the Silver Medal!');
		
	} else if (pointTotal > 29 && pointTotal < 150) {
	
	$('.rank').attr('src', '/img/silver.svg');
    $('.point').text(numberOfClaps);
	    $('.rank_title').text('Silver');
var point_remaining = 150 - pointTotal;
$('.encourage').text('You are only ' + point_remaining + ' points away from getting the Gold Medal!');
	} else if (pointTotal > 149 && pointTotal < 350) {
		
	$('.rank').attr('src', '/img/gold.svg');
    $('.point').text(numberOfClaps);
		   $('.rank_title').text('Gold');
var point_remaining = 350 - pointTotal;
	$('.encourage').text('You are only ' + point_remaining + ' points away from getting the Platinum Medal!');
	} else if (pointTotal > 349 && pointTotal < 650) {
	$('.rank').attr('src', '/img/plat.svg');
    $('.point').text(numberOfClaps);
    $('.rank_title').text('Platinum');
	var point_remaining = 650 - pointTotal;
	$('.encourage').text('You are only ' + point_remaining + ' points away from joining the top rank...Team Canada!');
	} else {	
	$('.rank').attr('src', '/img/red.svg');
    $('.point').text(numberOfClaps);
	$('.rank_title').text('Team Canada');
	$('.encourage').text('You are in a select group, among the most knowlegeable about Canada! Keep going!');
	} 
	if(percentage >= 0.8){
	var scorevalue = parseInt($('#test_score').val()) + 1;
	
 $.ajax({
           type:'POST',
           url:'/endpoints',
           data:{"test_score": scorevalue, "test_type": parseInt(test_type), "_token": "{{ csrf_token() }}"},
           error: function(jqXHR, textStatus, errorThrown) {
           alert('An error occurred... Look at the console (F12 or Ctrl+Shift+I, Console tab) for more information!');
            },
           success:function(data){
	...
	if (percentage >= 0.9){
    	$('.evaluate').append('Excellent');
		$('.evaldes').append("A great result, keep up the good work.");
		$('.circle-chart__circle').attr("stroke-dasharray", per + ",100"); 
$('.circle-chart__percent').html(per + "%");
	}
	else if (percentage >= 0.75 && percentage < 0.9){
		    	$('.evaluate').append('Good');
						    	$('.evaldes').append("Close to excellent...just a little more studying is required.");
...
$('.circle-chart__percent').html(per + "%");
	...
	$('.evaluate').append('Marginal');
				$('.evaldes').append("Your performance is fair, but will need some work before levelling up. You're not ready yet for the official test.");
...
$('.circle-chart__percent').html(per + "%");
    	score.append('Good job! You got ' + numCorrect + ' out of ' +
		    	...
		    	$('.evaluate').append('Poor');
														    	$('.evaldes').append("You've got some serious studying to improve your level. But don't worry. With some effort, you'll get there.");
