...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Canadian Economy</title>
...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
	...
	<h1 class="pink-text" style="font-weight: bold;">Canadian Economy</h1>
   <div class="d-flex justify-content-between progressbar">
            <small class="text-muted">Section Progress</small>
            <small><span><strong>1</strong></span>/<span></span>1</small>
		  </div>
...
<div style="margin-bottom: 100px;">
  ...
  <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <p class="text-center mx-auto mb-4 pb-2">You've just completed the Canadian Economy section of the Discover Canada guide. Keeping going!.</p>
...
$('#progressbar').animate({ width: "100%"}, 1000);	
        ...
        $.ajax({
           ...
           data:{"module": 10, "section":1, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"economy"},
