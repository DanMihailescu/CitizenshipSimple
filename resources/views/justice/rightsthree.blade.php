...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Rights and Responsibilities: Citizenship Responsibilities</title>
...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
            ...
            <small><span><strong>3</strong></span>/<span></span>4</small>
          </div>
          <div class="progress lg-progress">
            <div id="progressbar" class="progress-bar bg-danger animated flash" style="width: 50%;" role="progressbar"></div>
          </div>
...
You may also serve in the Coast Guard or emergency services in your community such as a police force or fire department. By helping to protect your community, you follow in the footsteps of Canadians before you who made sacrifices in the service of our country.
		</p><div class="text-right"> <button type="button" class="btn btn-danger btn-rounded
 ...
 <a href="/rights/citizenship-responsibilities" class="btn btn-danger btn-rounded">Continue Training</a>
...
$(document).ready(function(){
  ...
  var questions = [{
    question: "Which is an example of a barbaric practice?",
    choices: ['Shoplifting', 'Assault and Battery', 'Driving Under the Influence', 'Forced Marriage'],
    correctAnswer: 3,
	answerStore: "Forced Marriage"
  }, {
    question: "How are barbaric practices treated under Canadian Law?",
    choices: ["Severe Criminal Punishment", "Civil Punishment", "No Punishment"],
    correctAnswer: 0,
	answerStore: "Severe Criminal Punishment"
  }, {
...
$('#progressbar').animate({ width: "75%"}, 1000);	
        ...
        $.ajax({
           ...
           data:{"module": 3, "section":2, "completion":"no", "_token": "{{ csrf_token() }}", "nextsec":"defending-canada"},
