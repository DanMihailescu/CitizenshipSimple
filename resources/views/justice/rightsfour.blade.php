...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Who We Are: Rights and Responsibilities</title>
...
<img class="trophy" src="../img/trophy.svg" style="display:none; position: absolute; bottom: 0;" />
</div>
...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
            ...
            <small><span><strong>4</strong></span>/<span></span>4</small>
          </div>
          <div class="progress lg-progress">
            <div id="progressbar" class="progress-bar bg-danger animated flash" style="width: 75%;" role="progressbar"></div>
          </div>
...
You may also serve in the Coast Guard or emergency services in your community such as a police force or fire department. By helping to protect your community, you follow in the footsteps of Canadians before you who made sacrifices in the service of our country.
 ...
 <section class="congratulations text-center px-md-5 mx-md-5 dark-grey-text" style="display: none; padding-top: 25px;">
    ...
    <h1 class="font-weight-bold mb-4 pb-2">Congratulations!</h1>
    
    <p class="text-center mx-auto mb-4 pb-2">You've just completed the first section of the Discover Canada guide. Keeping going, or save your progress for later.</p>
    
 <button type="button" class="btn btn-danger btn-rounded training">Continue Training</button>
  ...
  $('#next').on('click', function (e) {
    ...
    if (isNaN(selections[questionCounter])) {
	  ...
	  $('#warning').text('');
			...
			$('.trophy').addClass('rotateInUpLeft');
			$('.trophy').show();
$('#progressbar').animate({ width: "100%"}, 1000);
 $.ajax({
           ...
           data:{"module": 4, "section":2, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec": "rights-intro"},
           ...
           success:function(data){
              ...
              if (data.success == 'yes'){
				  ...
				  window.location.href = "/discover-canada";
