...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: Rights and Responsibilities: Equality of Women and Men</title>
...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
   ...
   <div class="d-flex justify-content-between progressbar">
            ...
            <small><span><strong>2</strong></span>/<span></span>4</small>
          </div>
...
<div class="text-left" style="padding-top: 30px;padding-bottom: 0px;"><h4><b>Correctly answer <u><b>1</b></u> teaser questions in a row to continue...</b></h4></div>
...
$('#progressbar').animate({ width: "50%"}, 1000);	
        ...
        $.ajax({
           ...
           data:{"module": 2, "section":2, "completion":"no", "_token": "{{ csrf_token() }}", "nextsec":"citizenship-responsibilities"},
