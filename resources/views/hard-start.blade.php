...
<head>
  <meta charset="utf-8">
  <title>CitizenshipSimple: Hard Practice Test Start</title>
...
<div class="col-12">
  ...
  <section class="text-center white-text d-md-flex justify-content-between p-2 red lighten-2 rounded my-3">
    ...
    <h6 class="font-weight-bold  p-3 text-red">Your Trial Version uses 50 questions over and over. Upgrade free for 700+ more.</h6>
...
<div class="card animated fadeIn" style="border: 5px solid #ececec;border-radius: 15px;">
     <div class="card-body text-center">
			...
			<a class="btn btn-lg btn-danger" style="color: #fff;" href="/practice-test-with-answers?number=10&test=5&test_type=3">Begin Zip Test</a>
         </div>
		 </div>
          ...
          <i class="fas fa-clock fa-3x text-danger"></i>
            ...
            <div class="step-excerpt text-center" style="margin-top: 15px;">
              <p class="text-muted">The <b>full 20 Question Timed</b> Test. Must be completed within 30 minutes.</p>
						...
						<a class="btn btn-lg btn-danger" style="color: #fff;" href="/timed-test?number=20&test=6&test_type=3">Begin Simulation</a>
