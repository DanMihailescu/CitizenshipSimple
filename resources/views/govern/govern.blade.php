...
<head>
  <meta charset="utf-8">
  <title>Discover Canada: How Canadians Govern Themselves</title>
...
<a href="/discover-canada" class="text-right btn btn-rounded btn-sm btn-outline-grey btn-flat">Exit <i class="fas fa-external-link-alt"></i></a>
 ...
 <style>
	...
	<h1 class="pink-text" style="font-weight: bold;">How Canadians Govern Themselves</h1>
   <div class="d-flex justify-content-between progressbar">
            <small class="text-muted">Section Progress</small>
            <small><span><strong>1</strong></span>/<span></span>3</small>
          </div>
...
Every province has its own elected Legislative Assembly, like the House of Commons in Ottawa. The three northern territories, which have small populations, do not have the status of provinces, but their governments and assemblies carry out many of the same functions.
 ...
 <a href="/govern/govern-two" class="btn btn-danger btn-rounded">Continue Training</a>
...
function playApplause() {
  ...
  $('#next').on('click', function (e) {
   ...
   $.ajax({
           ...
           data:{"module": 6, "section":1, "completion":"yes", "_token": "{{ csrf_token() }}", "nextsec":"first-europeans"},
